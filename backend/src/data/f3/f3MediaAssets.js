/**
 * URLs oficiales F3 2026 (Cloudinary / fiaformula3.com).
 */

const F3_CLOUD = 'https://res.cloudinary.com/prod-f2f3/image/upload';

const portraitCard = (versionPath) =>
...
const PORTRAIT_PATH = {
  ...
  heuzenroeder: 'v1772030557/f3/global/drivers/2026/PreSeason/H431fh23vr0EevewvR_Web026.jpg',
...
export const F3_DRIVER_HEADSHOT_URL = Object.fromEntries(
  Object.entries(PORTRAIT_PATH).map(([id, path]) => [id, portraitCard(path)]),
);

export const F3_TEAM_LOGO_URL = {
