/**
 * URLs oficiales F2 2026 (Cloudinary / fiaformula2.com).
 * Usado por storage:upload y fallback API si la DB no tiene URL.
 */
...
export const F2_DRIVER_HEADSHOT_URL = Object.fromEntries(
  Object.entries(PORTRAIT_PATH).map(([id, path]) => [id, portraitCard(path)]),
);

export const F2_TEAM_LOGO_URL = {
