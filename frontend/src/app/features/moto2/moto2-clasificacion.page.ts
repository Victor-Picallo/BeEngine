  ...
  private fetchStandings(): void {
    ...
    startHybridLoad(
      [
        {
          load: () =>
            this.moto2.getDriverStandingsResponse(true).pipe(
        ...
        {
          load: () =>
            this.moto2.getOfficialTeamsGrid(true).pipe(
        ...
        {
          load: () =>
            this.moto2.getCalendar().pipe(catchError(() => of([] as JolpikaCalendarRace[]))),
