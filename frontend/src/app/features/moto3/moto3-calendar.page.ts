...
@Component({
  selector: 'app-moto3-calendar-page',
  standalone: true,
  imports: [
    RouterLink,
    ReturnNavDirective,
  ...
  templateUrl: './moto3-calendar.page.html',
  styleUrl: '../calendar/f1-calendar.page.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class Moto3CalendarPageComponent {
  ...
  allCards = computed<Moto3CalendarCard[]>(() => {
    ...
    return this.calendar().map((race) => {
      ...
      const status: Moto3CalendarCard['status'] =
  ...
  filteredCards = computed<Moto3CalendarCard[]>(() => {
    const f = this.filter();
  ...
  raceCardLink(card: Moto3CalendarCard): (string | number)[] {
